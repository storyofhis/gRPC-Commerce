...
type ProductServiceClient interface {
	...
	FindOne(ctx context.Context, in *FindOneDataRequest, opts ...grpc.CallOption) (*FindOneDataResponse, error)
...
func (c *productServiceClient) FindOne(ctx context.Context, in *FindOneDataRequest, opts ...grpc.CallOption) (*FindOneDataResponse, error) {
	out := new(FindOneDataResponse)
...
type ProductServiceServer interface {
	...
	FindOne(context.Context, *FindOneDataRequest) (*FindOneDataResponse, error)
...
func (UnimplementedProductServiceServer) FindOne(context.Context, *FindOneDataRequest) (*FindOneDataResponse, error) {
...
func _ProductService_FindOne_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProductServiceServer).FindOne(ctx, req.(*FindOneDataRequest))
	}
	return interceptor(ctx, in, info, handler)
}
